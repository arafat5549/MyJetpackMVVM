...
class SearchResultAdapter(data: MutableList<SearchResultResponse>?) :
    BaseDelegateMultiAdapter<SearchResultResponse, BaseViewHolder>(data) {
    ...
    constructor(data: MutableList<SearchResultResponse>?, showTag: Boolean) : this(data) {
    ...
    init {
        ...
        // 第一步，设置代理
        setMultiTypeDelegate(object : BaseMultiTypeDelegate<SearchResultResponse>() {
            override fun getItemType(data: List<SearchResultResponse>, position: Int): Int {
    ...
    override fun convert(helper: BaseViewHolder, item: SearchResultResponse) {
            ...
            Ariticle -> {
                ...
                item.run {
                    ...
                    helper.setText(
                        ...
                        Html.fromHtml("$superChapterName·$chapterName")
                    )
    ...
    interface OnCollectViewClickListener {
        fun onClick(item: SearchResultResponse, v: CollectView, position: Int)
    }
