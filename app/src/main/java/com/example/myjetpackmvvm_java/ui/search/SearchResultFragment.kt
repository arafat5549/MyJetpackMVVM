...
import com.example.myjetpackmvvm_java.databinding.FragmentSearchResultBinding
    ...
    override fun initView()  {
        ...
        articleAdapter.run {
            setOnCollectViewClickListener(object :
                SearchResultAdapter.OnCollectViewClickListener {
                override fun onClick(item: SearchResultResponse, v: CollectView, position: Int) {
