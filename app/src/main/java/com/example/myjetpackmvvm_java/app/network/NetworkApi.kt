package com.example.myjetpackmvvm_java.app.network

import com.example.myjetpackmvvm_java.App
import com.example.myjetpackmvvm_java.app.NetApiService
...
class NetworkApi : BaseNetworkApi() {
    ...
    val service2: NetApiService by lazy {
        getApi(NetApiService::class.java, NetApiService.SERVER_URL_LOCAL)
    }
